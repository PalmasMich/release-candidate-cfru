...
SCRIPT=ROOT/"scripts"/"discover_castello_map_slot.py"

def load():
    s=importlib.util.spec_from_file_location("castello_slot",SCRIPT)
    m=importlib.util.module_from_spec(s); s.loader.exec_module(m); return m

class TestCastelloSlot(unittest.TestCase):
    def build_rom(self,m,duplicate=False):
        ...
        def write(o):
            ...
            h[20]=m.MAPSEC_SEVII_ISLE_6;h[21]=0;h[22]=m.WEATHER_SUNNY;h[23]=m.MAP_TYPE_ROUTE
    ...
    def test_unique(self):
        ...
        self.assertEqual((r["map_group"],r["map_num"]),(3,50))
        self.assertNotEqual(r["candidates"][0]["connections_ptr"],0)
        self.assertEqual(r["candidates"][0]["layout"]["width"],1)
