...
SCRIPT=ROOT/"scripts"/"discover_port_link_map_slot.py"

def load():
    s=importlib.util.spec_from_file_location("port_slot",SCRIPT)
    m=importlib.util.module_from_spec(s); s.loader.exec_module(m); return m

class TestPortLinkSlot(unittest.TestCase):
    def build_rom(self,m,duplicate=False):
        ...
        layout[0:4]=(24).to_bytes(4,"little",signed=True)
        layout[4:8]=(60).to_bytes(4,"little",signed=True)
        ...
        def write(o):
            ...
            h[20]=m.MAPSEC_SEVII_ISLE_9;h[21]=0;h[22]=m.WEATHER_SUNNY;h[23]=m.MAP_TYPE_ROUTE
    ...
    def test_unique(self):
        ...
        self.assertEqual((r["map_group"],r["map_num"]),(3,53))
        self.assertEqual(r["candidates"][0]["layout"]["height"],60)
