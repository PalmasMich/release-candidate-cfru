...
VISIBLE_TEXT_REPLACEMENTS = (
    ...
    (encode_text("My name is OAK."), encode_text("Sono il Delivery Lead.")),
    ...
    (encode_text("What is it?"), encode_text("Come ti chiami?")),
    (encode_text("This is my grandson."), encode_text("Lui è il tuo collega.")),
    (encode_text("He's been your rival since you both"), encode_text("Tiene i KPI da prima del kickoff")),
    (encode_text("were babies."), encode_text("e ama le classifiche.")),
    ...
    (encode_text("to unfold!"), encode_text("cominciare.")),
    (encode_text("A world of dreams and adventures"), encode_text("Cagliari ti aspetta.")),
    (encode_text("with POKéMON awaits! Let's go!"), encode_text("Il progetto è già iniziato. Vai!")),
    (encode_text("I see! BULBASAUR is your choice."), encode_text("TARTREK è il tuo nuovo partner!")),
    (encode_text("Hm! SQUIRTLE is your choice."), encode_text("FROBYTE è il tuo nuovo partner!")),
    (encode_text("Ah! CHARMANDER is your choice."), encode_text("EMBERFOX è il tuo nuovo partner!")),
    ...
    (encode_text("Come on, I'll take you on!"), encode_text("KPI check: vediamo la velocity!")),
